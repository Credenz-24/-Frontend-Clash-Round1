...
const Circles = (props) => {
    ...
    return ( 
        ...
        <>
            <div className="skills h-[22vh] w-[22vh] relative  justify-center items-center bg-green-900">
                ...
                <svg className=" bg-red-500 opacity-[40%] h-full w-full flex justify-center items-center absolute " xmlns ="http://www.w3.org/2000/svg"version="1.1" width="22vh" height ="22vh">
